...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" data-aos="fade-up" data-aos-delay="80">
        ...
        <form method="POST" action="{{ route('doctors.store') }}" class="p-6 space-y-6" data-aos="fade-up" data-aos-delay="150">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2" data-aos="fade-left" data-aos-delay="340">
                ...
                <div class="md:col-span-2" data-aos="fade-left" data-aos-delay="360">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100" data-aos="fade-up" data-aos-delay="400">
