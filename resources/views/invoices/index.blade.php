...
<div class="space-y-6">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
            ...
            <a href="{{ route('invoices.create') }}" class="px-6 py-2.5 bg-gradient-to-l from-orange-600 to-orange-700 text-white rounded-xl font-semibold hover:from-orange-700 hover:to-orange-800 transition flex items-center gap-2 shadow-lg shadow-orange-600/20">
