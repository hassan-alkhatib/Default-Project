...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" data-aos="fade-up" data-aos-delay="80">
        ...
        <form method="POST" action="{{ route('medical-records.store') }}" class="p-6 space-y-6" data-aos="fade-up" data-aos-delay="150">
            @csrf
            ...
            <div class="p-5 border rounded-xl bg-green-50/50" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="space-y-4" data-aos="fade-up" data-aos-delay="340">
                <div>
