...
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p class="text-3xl font-extrabold text-gray-800 mt-1">{{ number_format($totalAppointments) }}</p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <p class="text-sm text-gray-500">مواعيد اليوم</p>
            <p class="text-3xl font-extrabold text-blue-600 mt-1">{{ number_format($todayAppointments) }}</p>
        </div>
    </div>
