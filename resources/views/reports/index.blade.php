...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <a href="{{ route('reports.patients') }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 hover:shadow-lg transition-all group">
    ...
    <a href="{{ route('reports.appointments') }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 hover:shadow-lg transition-all group">
    ...
    <a href="{{ route('reports.revenue') }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 hover:shadow-lg transition-all group">
